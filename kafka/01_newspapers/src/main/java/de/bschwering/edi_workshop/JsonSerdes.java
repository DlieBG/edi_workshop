...
public class JsonSerdes {
	...
	public static Serde<Edition> editionSerde() {
		return Serdes.serdeFrom(
				(topic, data) -> writeValue(data), 
				(topic, data) -> readValue(data, Edition.class));
	}

	public static Serde<Subscription> subscriptionSerde() {
		return Serdes.serdeFrom(
				(topic, data) -> writeValue(data), 
				(topic, data) -> readValue(data, Subscription.class));
	}
